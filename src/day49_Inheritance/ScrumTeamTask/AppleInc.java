...
public class AppleInc {
    ...
    public static void main(String[] args) {
        Tester tester1 = new Tester("Aizhan", 30, 'F', 125000, 123456, "SDET");
        Tester tester2 = new Tester("Minara", 30, 'F', 125000, 123421, "SDET");
        Tester tester3 = new Tester("Mia", 33, 'M', 135000, 765456, "SDET");
